const validateEnv = () => {
    ...
    if (!razorpayKeyId.startsWith('rzp_test_') && !razorpayKeyId.startsWith('rzp_live_')) {
        console.error('❌ Invalid RAZORPAY_KEY_ID format. It should start with "rzp_test_" or "rzp_live_"');
        process.exit(1);
    }

    console.log('✅ All environment variables are set');
    console.log(`✅ Razorpay integration configured (${razorpayKeyId.startsWith('rzp_test_') ? 'Test' : 'Live'} mode)`);
};
