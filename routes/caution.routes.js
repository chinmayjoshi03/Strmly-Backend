...
router.patch("/community/remove-video", authenticateToken, RemoveVideoFromCommunity);
...
router.patch("/community/remove-user", authenticateToken, RemoveUserFromCommunity);
